...
<Frame caption="Browser extension collecting training data to build the Action Tree">
<img src="/the-action-model/images/LAMToken.jpg" alt="Action Model browser extension interface" />
</Frame>
...
The **[Action Tree](/the-large-action-model-lam/training-the-large-action-model)** is an interconnected map of every possible action across the internet - built by your Action Branches

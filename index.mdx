...
<Tabs>
<Tab title="Web3 Expertise" icon="ethereum">

**Deep Understanding of Decentralization**

- Built and scaled multiple DeFi protocols
- Pioneered tokenomics models that align incentives
- Understand the importance of community ownership
- Experience navigating regulatory landscapes

</Tab>
<Tab title="AI Innovation" icon="brain">

**Cutting-Edge AI Development**

- Published research in computer vision and NLP
- Built production AI systems at scale
- Expertise in reinforcement learning for GUI automation
- Pioneer in action-based AI models

</Tab>
<Tab title="Execution Track Record" icon="rocket">

**Proven Ability to Deliver**

- Multiple successful exits and acquisitions
- Products with millions of active users
- Raised and deployed &#36;200M+ in capital
- Built teams from 0 to 100+ employees
...
**Join the Team**: We're always looking for exceptional talent. If you're passionate about democratizing AI and building the future of automation, [reach out to us](https://actionmodel.com/careers).

...
description: "Action Model is the world's first community-owned Large Action Model (LAM)—an AI built to act, not just generate text. Every click helps you train it, earn rewards, and build a fairer AI future we all own together."
---

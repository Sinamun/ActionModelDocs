...
<Frame>
  <img src="/actionist/images/memories.png" alt="Actionist Memory" />
</Frame>

**Your agents never forget**

Memory gives your agents context and continuity:

- **Platform Credentials**: Securely store login information
- **User Preferences**: Remember how you like things done
- **Relationship Mapping**: Track connections between platforms and data
- **Historical Context**: Learn from past executions and outcomes
- **Business Knowledge**: Custom information about your processes

This persistent memory means agents get smarter over time, understanding your business better with each interaction.
...
- **Video Playback**: Watch exactly what your agent did
- **Action Logs**: Detailed record of every click, type, and decision
- **Error Tracking**: Understand when and why something didn't work
- **Compliance Records**: Maintain audit trails for regulatory requirements
- **Performance Analytics**: Measure efficiency and optimize workflows

The history feature ensures transparency, accountability, and continuous improvement of your automation processes.

<Card title="Explore History & Auditing" icon="clock-rotate-left" href="/actionist/agent-history">

Learn about video playback, logs, and compliance tracking

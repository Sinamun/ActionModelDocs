...
<Card title="Content Creation + Publishing" icon="wand-magic-sparkles" href="/actionist/app-demos-and-examples#content-creation-social-media-publishing">
...
<Card title="HR CV Screening" icon="user-check" href="/actionist/app-demos-and-examples#cv-screening-interview-scheduling">
...
<Card title="Sales CRM Automation" icon="envelope-open-text" href="/actionist/app-demos-and-examples#crm-email-campaign-automation">

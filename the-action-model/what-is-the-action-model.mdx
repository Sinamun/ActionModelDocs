...
**Proven Track Record**: Our team brings together veterans from leading Web3 projects who have collectively raised over $200M, built products used by millions, and pioneered breakthrough technologies in blockchain and AI.
...
<CardGroup cols={2}>
<Card title="Visionary Leadership" icon="crown" color="#9333ea">

**Experienced founders and executives** who've built and scaled successful Web3 companies:

- **Sina Yamani** - Yoello (Exit)
- **Jan Camenisch** - CTO ICP
- **Mario Casiraghi** - CFO AGI / Singularity DAO
- **Andrew Saunders** - CMO Arbitrum

</Card>

<Card title="Technical Excellence" icon="code" color="#3b82f6">

**World-class engineers** building the future of AI automation:

- **20+ engineers** with expertise in AI/ML, distributed systems, and blockchain
- Veterans from **NEAR, Polygon, Polkadot, Uniswap**
- Deep experience in large-scale infrastructure and protocol design
...
<Frame>
  <img src="/the-action-model/images/team-companies.png" alt="Team Web3 Experience" />
</Frame>

Our team has contributed to and led some of the most innovative projects in Web3:
...
<Card title="Internet Computer">
**Decentralized Computing**
</Card>

<Card title="Changelly">
...
<CardGroup cols={2}>
<Card title="Passive Training" icon="play-circle">

Runs in background while you browse normally, earning tokens automatically

</Card>
<Card title="Active Training" icon="record-vinyl">
...
<Card title="Join the Uprising" icon="fist-raised" href="/the-action-model/action-model-is-the-uprising">

...
## Creator Epochs: Permanent Marketplace Rewards

### Early Creator Advantage

<Info>

**Forever Locked Rewards**: When you publish a workflow to the marketplace, it gets tagged with the current Creator Epoch. This determines your permanent reward percentage from the token distribution—forever. A workflow published in Month 1 earns 33% of consumed tokens in perpetuity, while Month 9 workflows only earn 5%.
...
**Key Difference**: This is separate from the training epoch multipliers above. Creator Epochs specifically apply to marketplace workflow rewards from the token distribution system.

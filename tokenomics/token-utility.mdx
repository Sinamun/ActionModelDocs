...
Each consumed action distributes tokens: **Burn**, **Marketplace Distribution**, **Action Model Foundation** (foundation ops, rewards, R&amp;D).
...
| **🏛️ Foundation** | 33% | `0.33 × τ` tokens | Funds development, operations, rewards, and R&amp;D |

### Example Distribution

| Action Size | Tokens Consumed | 🔥 Burned | 💡 To Creator | 🏛️ To Foundation |
|------------|-----------------|-----------|---------------|-------------------|
| Small Task | 10 tokens | 3.4 tokens | 3.3 tokens | 3.3 tokens |
| Medium Task | 100 tokens | 34 tokens | 33 tokens | 33 tokens |
| Large Task | 1,000 tokens | 340 tokens | 330 tokens | 330 tokens |
| Enterprise | 10,000 tokens | 3,400 tokens | 3,300 tokens | 3,300 tokens |

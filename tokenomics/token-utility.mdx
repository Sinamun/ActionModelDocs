...
<Tabs>
<Tab title="Pricing Model" icon="calculator">

### Versioned "Price Per Action"
...
<Tab title="Buyback Loop" icon="arrows-rotate">

### Why Usage Creates Demand
...
<Tab title="Per-Action Accounting" icon="sigma">

### 9.1 Per-Action Accounting (LAM-v)
...
<Tab title="Network-Level" icon="network-wired">

### 9.2 Network-Level, Period t (e.g., monthly)
...
<Tab title="Supply Dynamics" icon="chart-line">
...
### 9.4 "Half-Life" Under Constant Burn and No Emissions (Illustrative)

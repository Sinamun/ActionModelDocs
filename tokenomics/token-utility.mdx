...
<CardGroup cols={3}>
<Card title="Action Fuel" icon="gas-pump" href="#how-%24lam-powers-every-action">
...
<Frame caption="The Action Loop - How Each AI Decision Consumes $LAM">
  <img src="/the-action-model/images/ActionLoop.jpg" alt="Action Loop Token Consumption" />
</Frame>
...
<Frame caption="The Action Loop - How Each AI Decision Consumes $LAM">
  <img src="/tokenomics/images/ActionLoopDetail.jpg" alt="Action Loop Token Consumption" />
</Frame>
...
**B2C + B2B + Partners create continuous buy pressure.** <br/> Subscriptions and API usage require $LAM purchases to fund actions
...
Goes to workflow creators based on their [Creator Epoch](/tokenomics/point-tiers-and-epochs#creator-epochs-permanent-marketplace-rewards) when their automations are used
...
Permanently removed from circulation, creating scarcity with every action

</Card>

<Card title="33% Ecosystem" icon="seedling" color="#3b82f6">

**Platform Growth**

Powers ecosystem development, operations, and community initiatives
...
|-------------|------------|---------|---------|
| **💡 Creator** | 33% | `0.33 × τ` tokens | Rewards workflow creators when their automations are used |
...
**Creator Epoch Rewards**: The actual creator percentage varies by when workflows are published. See [Creator Epoch table](/tokenomics/point-tiers-and-epochs#creator-epochs-permanent-marketplace-rewards) for specific reward rates (5-33%).
...
33% to creators, 34% burned, 33% to ecosystem
...
For LAM-1 (`p₁ = $0.10`): **$0.033** goes to the creator (if used), **$0.034** is burned, and **$0.033** to the ecosystem **per action**, independent of token price.

...
<CardGroup cols={3}>
<Card title="🔥 Burned Forever" color="#ef4444">

**34% of tokens**

`0.34 × τ` tokens

Permanently removed from circulation with every action

</Card>

<Card title="💡 Creator Rewards" color="#10b981">

**33% of tokens**

`0.33 × τ` tokens

Paid to workflow creators when their automations are used

</Card>

<Card title="🏛️ Foundation" color="#3b82f6">

**33% of tokens**

`0.33 × τ` tokens

Funds development, operations, and ecosystem growth
...
**Example**: For an action consuming 100 tokens:
- 34 tokens are burned forever
- 33 tokens go to the creator (if using a marketplace workflow)
- 33 tokens go to the foundation

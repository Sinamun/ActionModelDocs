...
**Creator Epoch Rewards**: The actual creator percentage varies by when workflows are published. See [Creator Epoch table](/tokenomics/marketplace-distributions#creator-epochs-time-based-reward-tiers) for specific reward rates.

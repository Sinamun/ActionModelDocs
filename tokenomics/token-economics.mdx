...
| Year | Daily Actions | Daily Burn | Annual Burn | Remaining Supply |
|------|---------------|------------|-------------|------------------|
| 2025 | 10 million | 3.4M tokens | 1.24B tokens | 998.76M |
| 2026 | 100 million | 34M tokens | 12.4B tokens | 986.36M |
| 2027 | 500 million | 170M tokens | 62B tokens | 924.36M |
| 2028 | 1 billion | 340M tokens | 124B tokens | 800.36M |
| 2029 | 2 billion | 680M tokens | 248B tokens | 552.36M |

<Info>

**The Halving Effect**: As supply decreases and demand increases, each remaining token captures more value. Early holders benefit from both appreciation and scarcity.
...
<Frame caption="Revenue Cycle - How Business Demand Drives Token Value">
  <img src="/images/revenue-cycle-diagram.png" alt="B2B Revenue Cycle" />
</Frame>
...
- 33% to creators (incentive alignment)
...
<CardGroup cols={3}>
<Card title="Start Earning" icon="coins" href="/tokenomics/training-to-earn-tokens" color="#9333ea">

...
- L1: 10 users × 100k × 27% = 270,000 points (Silver tier rate)
- L2: L1 earns 1.35M from their 50 referrals → You earn 25% = 337,500 points
- L3: L2 earns 1.69M from their 250 referrals → You earn 25% = 421,875 points
- **Total**: 1,029,375 points/month
...
**Monthly Earnings** (100k points average per user):
- L1: 100 users × 100k × 30% = 3,000,000 points (Gold tier rate)
- L2: L1 earns 15M from their 500 referrals → You earn 25% = 3,750,000 points
- L3: L2 earns 18.75M from their 2,500 referrals → You earn 25% = 4,687,500 points
- **Total**: 11,437,500 points/month

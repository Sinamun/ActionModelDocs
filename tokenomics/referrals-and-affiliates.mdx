...
<CardGroup cols={3}>
<Card title="More people to train the LAM" icon="database" href="/the-large-action-model-lam/training-the-large-action-model">

With enough users, we will be able to collect enough rich training data to create a world-leading Large Action Model

</Card>

<Card title="More people to create workflows" icon="sitemap" href="/marketplace/marketplace-overview">

Wider array and breadth of workflows, covering all B2B and Enterprise requirements

</Card>

<Card title="More Distribution of the Actionist" icon="rocket" href="/actionist/actionist-overview">

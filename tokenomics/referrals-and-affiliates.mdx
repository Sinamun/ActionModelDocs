...
<Frame >
  <img src="/the-action-model/images/JoinRevolution.jpg" alt="3-Layer Referral Network" />
</Frame>
...
[Learn more about training the LAM →](/the-large-action-model-lam/training-the-large-action-model)
...
[Learn more about the marketplace →](/marketplace/marketplace-overview)

</Card>

<Card title="More Distribution of the Actionist" icon="rocket">

Finally, we need you to tell businesses to use the Actionist! Your advocacy drives adoption and creates the revenue that powers our tokenomics.

[Learn more about Actionist→](/actionist/actionist-overview)
...
**The revenue generated from the Actionist is used to buy-back and burn tokens** — creating deflationary pressure that benefits all token holders. [Learn more about Token Utility →](/tokenomics/token-utility)
...
Earn up to 25% of all $LAM your direct referrals generate forever (based on your tier level)

</Card>

<Card title="One-Time Bonuses" icon="gift">

Receive up to 80,000 bonus LAM points for each referral at sign-up and qualification milestones
...
<Frame caption="3-Layer Network Visualization - How Your Influence Compounds">
  <img src="/tokenomics/images/REF.png" alt="3-Layer Referral Network" />
</Frame>
...
To encourage community growth, you can earn extra LAM points by referring others. There are two ways you benefit:

### 1. Affiliate Earnings – Ongoing Percentage of Referees' LAM Points

As your number of successful referrals grows, so does the percentage of their earned LAM points you receive — without affecting their LAM points total.

| Tier | Number of Referrals | Affiliate Bonus (% of Referees' LAM Points) |
|------|---------------------|------------------------------------------|
| **Tier 1** | 0–5 | 5% |
| **Tier 2** | 6–20 | 10% |
| **Tier 3** | 21–100 | 15% |
...
**Example calculation:**
Someone you referred earns 10,000 LAM points in a session. If you're in Tier 3 (15%), you'll receive:
ROUND(10,000 * 15 / 100) = 1,500 bonus LAM points

### 2. One-Time Referral Bonuses

You'll also receive fixed bonus LAM points at two key milestones for each person you refer:

| Tier | Initial Bonus (on sign-up) | Qualified Bonus (after 10min recording) | Total Bonus |
|------|----------------------------|------------------------------------------|-------------|
| **Tier 1** | 1000 LAM points | 4000 LAM points | 5000 |
| **Tier 2** | 2000 LAM points | 8000 LAM points | 10000 |
| **Tier 3** | 4000 LAM points | 16000 LAM points | 20000 |
| **Tier 4** | 8000 LAM points | 32,000 LAM points | 40000 |
| **Tier 5** | 16,000 LAM points | 64,000 LAM points | 80000 |
...
**Your Direct Referrals (L1)**: 5 people
**L2 Network**: 25 people (5 × 5)
**L3 Network**: 125 people (25 × 5)
**Total Network**: 155 people

**Your Tier**: Tier 1 (5% commission rate)

**Monthly Earnings** (assuming each person earns 100k LAM points/month):

**Direct Referral Earnings (L1)**:
- Ongoing: 5 users × 100k × 5% = 25,000 LAM points/month
- One-time: 5 × 5,000 = 25,000 LAM points

**L2 Network Earnings**:
- Each L1 earns: 5 × 100k × 5% = 25,000 LAM points from their referrals
- Your share (25% of L1's earnings): 5 × 25,000 × 25% = 31,250 LAM points/month

**L3 Network Earnings**:
- Each L2 earns: 5 × 100k × 5% = 25,000 LAM points from their referrals
- L1's share: 25 × 25,000 × 25% = 156,250 LAM points
- Your share (25% of L1's share): 156,250 × 25% = 39,062 LAM points/month

**Total Monthly Recurring**: 95,312 LAM points/month
**Plus One-Time Bonuses**: 25,000 LAM points
...
**Your Direct Referrals (L1)**: 50 people
**L2 Network**: 250 people (50 × 5)
**L3 Network**: 1,250 people (250 × 5)
**Total Network**: 1,550 people
...
**Direct Referral Earnings (L1)**:
- Ongoing: 50 users × 100k × 15% = 750,000 LAM points/month
- One-time: 50 × 20,000 = 1,000,000 LAM points

**L2 Network Earnings**:
- Each L1 earns: 5 × 100k × 5% = 25,000 LAM points from their referrals
- Your share (25% of L1's earnings): 50 × 25,000 × 25% = 312,500 LAM points/month

**L3 Network Earnings**:
- Each L2 earns: 5 × 100k × 5% = 25,000 LAM points from their referrals
- L1's share: 250 × 25,000 × 25% = 1,562,500 LAM points
- Your share (25% of L1's share): 1,562,500 × 25% = 390,625 LAM points/month

**Total Monthly Recurring**: 1,453,125 LAM points/month
**Plus One-Time Bonuses**: 1,000,000 LAM points
...
**Your Direct Referrals (L1)**: 1,000 people
**L2 Network**: 5,000 people (1,000 × 5)
**L3 Network**: 25,000 people (5,000 × 5)
...
**Direct Referral Earnings (L1)**:
- Ongoing: 1,000 users × 100k × 25% = 25,000,000 LAM points/month
- One-time: 1,000 × 80,000 = 80,000,000 LAM points

**L2 Network Earnings**:
- Each L1 earns: 5 × 100k × 5% = 25,000 LAM points from their referrals
- Your share (25% of L1's earnings): 1,000 × 25,000 × 25% = 6,250,000 LAM points/month

**L3 Network Earnings**:
- Each L2 earns: 5 × 100k × 5% = 25,000 LAM points from their referrals
- L1's share: 5,000 × 25,000 × 25% = 31,250,000 LAM points
- Your share (25% of L1's share): 31,250,000 × 25% = 7,812,500 LAM points/month

**Total Monthly Recurring**: 39,062,500 LAM points/month
**Plus One-Time Bonuses**: 80,000,000 LAM points

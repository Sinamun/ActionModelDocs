...
<Frame caption="Browse thousands of workflows organized by platform with clear bounty indicators">
  <img src="/marketplace/images/marketplace-2.png" alt="Marketplace Homepage" />
</Frame>
...
<Frame caption="View all published workflows for a specific platform">
...
<Frame caption="Detailed workflow configuration and preview">
  <img src="/marketplace/images/workflow-config-screenshot.png" alt="Workflow Configuration" />
</Frame>

#### Two Types of Workflows

<Tabs>
<Tab title="Basic Workflows" icon="list">
...
<Tab title="Complex Workflows" icon="sitemap">

**Advanced automations with logic**
- **Chains**: Connect multiple workflows together
- **Loops**: Repeat actions until conditions are met
- **IF Conditions**: Branch based on specific criteria
- **Variables**: Dynamic data handling
- **Error Handling**: Built-in fallback mechanisms

Example: "Scrape competitor prices, compare with ours, adjust if needed, notify team"
...
Customize workflow behavior with input parameters

</Card>

<Card title="Rules" icon="shield-check">

Set conditions and constraints for execution

</Card>

<Card title="Ask Human" icon="user-check">

Require human approval at critical decision points

</Card>

<Card title="Success Criteria" icon="circle-check">
